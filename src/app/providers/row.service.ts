...
export class RowService {
    ...
    /**
     * A message for all boxes in the row
     */
    public messageForAllBoxesInTheRow = new EventEmitter();


    /**
     * The states of the boxes in the row
     */
    ...
    calculateTheFrequency() {
        ...
        for(let possibleValue in frequency){
            ...
            if(frequency[possibleValue] == 1){
                this.sendMessageToAllBoxesInTheRow({
    ...
    handleBoxChange(box) {
        ...
        if(box.possibleValues.length == 1){
            ...
            this.sendMessageToAllBoxesInTheRow({
                message: 'The following value has been discovered in the row',
    ...
    sendMessageToAllBoxesInTheRow(data) {
        this.messageForAllBoxesInTheRow.emit(data);
    }
